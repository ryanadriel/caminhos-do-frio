...
<section class="pt-5 pt-md-9" id="service">
    ...
    <div class="container">
        <div class="position-absolute z-index--1 end-0 d-none d-lg-block"><img src="{{url('images/category/shape.svg')}}" style="max-width: 200px" alt="service" /></div>
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 mb-6">
                <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                    <div class="card-body p-xxl-5 p-4"> <img src="{{url('images/category/icon1.png')}}" width="75" alt="Service" />
            ...
            <div class="col-lg-3 col-sm-6 mb-6">
                <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                    <div class="card-body p-xxl-5 p-4"> <img src="{{url('images/category/icon2.png')}}" width="75" alt="Service" />
            ...
            <div class="col-lg-3 col-sm-6 mb-6">
                <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                    <div class="card-body p-xxl-5 p-4"> <img src="{{url('images/category/icon3.png')}}" width="75" alt="Service" />
            ...
            <div class="col-lg-3 col-sm-6 mb-6">
                <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                    <div class="card-body p-xxl-5 p-4"> <img src="{{url('images/category/icon4.png')}}" width="75" alt="Service" />
